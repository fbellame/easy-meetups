...
export default function EventFormClient({ initialData, isEditing = false, hosts, speakers }: EventFormClientProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const submitData = {
        ...
        event_banner_url: formData.event_banner_url || '',
    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <div className="space-y-4">
          ...
          {speakers.length === 0 && (
            <p className="text-gray-500 text-center py-4">No speakers available. <a href="/speakers/new" className="text-blue-600 hover:text-blue-800">Add speakers first</a>.</p>
          )}
        </div>
      </div>
