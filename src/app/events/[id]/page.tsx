                      ...
                      <div className="mt-2 space-y-2">
                        {eventSpeaker.speaker?.email && (
                          <div className="flex items-center text-sm text-gray-600">
                            ...
                            <span>{eventSpeaker.speaker.email}</span>
                          </div>
                        )}
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          {eventSpeaker.speaker?.social_links?.github && (
                            <a 
                              href={eventSpeaker.speaker.social_links.github}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center justify-center w-8 h-8 bg-gray-800 text-white rounded-full hover:bg-gray-900 transition-colors duration-200"
                          ...
                          {eventSpeaker.speaker?.social_links?.twitter && (
                            <a 
                              href={eventSpeaker.speaker.social_links.twitter}
                              target="_blank"
                              rel="noopener noreferrer"
                          ...
                          {eventSpeaker.speaker?.social_links?.website && (
                            <a 
                              href={eventSpeaker.speaker.social_links.website}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center justify-center w-8 h-8 bg-green-600 text-white rounded-full hover:bg-green-700 transition-colors duration-200"
                              title="Website"
                            >
